...
- The block line is inclusive, so `amountToClearBlock` is one paisa past it: paying exactly that figure lifts the block (owe 4,270 on a 3,000 limit → 1,270.01; owe exactly 3,000 → 0.01). Same rule for branches.
