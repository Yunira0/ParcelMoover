...
// The ledger posts off these same status transitions, but what it writes is
// covered by the accounting suites - here it would only demand that every
// account/entry table be mocked too, for assertions this file never makes.
